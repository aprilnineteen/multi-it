...
public class PagingVO {
	//페이징 처리 관련 프로퍼티
	private int pageNum; //현재 보여 줄 페이지 번호
	private int oneRecordPage = 5; //한 페이지당 보여 줄 목록 개수
	...
	private int end;
	//페이징 블럭 처리 위한 프로퍼티
	private int pagingBlock = 5; //한 블럭 당 보여 줄 페이지 수
	private int prevBlock; // 이전 다섯 개 (이전 블럭)
	private int nextBlock; // 이후 다섯 개 (이후 블럭)
	//검색 관련 프로퍼티
